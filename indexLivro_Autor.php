...
<body >
    ...
    <div >
        ...
        <tr><td><?php echo $linha['l_titulo'];?></td>
            ...
            <td><a href='cadLivro_Autor.php?acao=editar&la_l_idLivro=<?php echo $linha['la_l_idLivro'];?>&la_a_idAutor=<?php echo $linha['la_a_idAutor'];?>'> <img src="img/editar.png" style="width: 2.5vw;"></a></td>
            <td><?php echo " <a href=javascript:excluir('acaoLivro_Autor.php?acao=excluir&la_a_idAutor={$linha['la_a_idAutor']}&la_l_idLivro={$linha['la_l_idLivro']}')>";?><img src="img/deletar.png" style="width: 2.5vw;"></a></td>
        </tr>
