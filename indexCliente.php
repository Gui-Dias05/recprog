...
<body >
    ...
    <div >
            ...
            <form method="post">
                <div >
                    ...
                    <p>Ordenar e pesquisar por:</p>
                        ...
                        <input type="radio" name="busca" value="3" <?php if ($busca == "3") echo "checked" ?>> CPF<br>
                    <br>
        ...
        <tr><td><?php echo $linha['c_idCliente'];?></td>
            ...
            <td><a href='cadCliente.php?acao=editar&c_idCliente=<?php echo $linha['c_idCliente'];?>'> <img src="img/editar.png" style="width: 2.5vw;"></a></td>
            <td><?php echo " <a href=javascript:excluir('acaoCliente.php?acao=excluir&c_idCliente={$linha['c_idCliente']}')>";?><img src="img/deletar.png" style="width: 2.5vw;"></a></td>
        </tr>
